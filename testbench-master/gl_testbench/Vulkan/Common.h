...
constexpr uint32_t MAX_NUM_STORAGE_DESCRIPTORS = MAX_NUM_DESCRIPTOR_SETS * 64;///*DESCRIPTOR_SETS_PER_TRIANGLE * */VERTEX_BUFFER_DESCRIPTORS_PER_SET_BUNDLE;
constexpr uint32_t MAX_NUM_UNIFORM_DESCRIPTORS = MAX_NUM_DESCRIPTOR_SETS * 64;///*DESCRIPTOR_SETS_PER_TRIANGLE * */CONSTANT_BUFFER_DESCRIPTORS_PER_SET_BUNDLE;
constexpr uint32_t MAX_NUM_SAMPLER_DESCRIPTORS = MAX_NUM_DESCRIPTOR_SETS * 64;///*DESCRIPTOR_SETS_PER_TRIANGLE * */SAMPLER_DESCRIPTORS_PER_SET_BUNDLE;