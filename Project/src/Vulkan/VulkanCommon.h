...
inline VkFormat convertFormat(ETextureFormat format)
{
    ...
    case ETextureFormat::FORMAT_R16G16_FLOAT:       return VK_FORMAT_R16G16_SFLOAT;
...
inline const char* resultAsString(VkResult result)
{
    switch (result)
    {
...
inline const char* formatAsString(VkFormat format)
{
    switch (format)
    {
...
constexpr uint32_t MAX_NUM_UNIQUE_MATERIALS = 128;