...
//Light pass
#define LP_GBUFFER_ALBEDO_BINDING		1
#define LP_GBUFFER_NORMAL_BINDING		2
#define LP_GBUFFER_VELOCITY_BINDING		3
#define LP_GBUFFER_DEPTH_BINDING		4
#define LP_IRRADIANCE_BINDING			5
#define LP_ENVIRONMENT_BINDING			6
#define LP_BRDF_LUT_BINDING				7
#define LP_RADIANCE_BINDING				8
#define LP_GLOSSY_BINDING				9
#define LP_LIGHT_BUFFER_BINDING			10
